...
This skill provides comprehensive guidance and tools for creating effective skills.
...
This skill-creator is based on and inspired by [Dify's skill-creator](https://github.com/langgenius/dify/tree/main/.agents/skills/skill-creator), with enhancements including:
...
- Screenshots or GIFs showing the skill in action
- Setup and configuration steps
- Human-readable explanations

**What to include:**
- **Screenshots/GIFs**: Show the skill in action
- **Example Prompts**: "Try saying: 'Help me rotate this PDF' or 'Analyze these quarterly results'"
- **Installation Instructions**: Clear, step-by-step setup guide
- **Dependencies**: List all required packages and tools
...
- **SKILL.md** → For AI agents (Claude reads this to understand how to use the skill)

The `init_skill.py` script automatically generates a README.md template with helpful structure when creating new skills.
